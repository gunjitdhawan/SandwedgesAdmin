...
public class OrderCompleteActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// Locate the EditText in listview_main.xml
				editsearch = (EditText) findViewById(R.id.editTextcom);
	...
	private class RemoteDataTask extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			...
			mProgressDialog = new ProgressDialog(OrderCompleteActivity.this);
		...
		protected void onPostExecute(Void result) {
			...
			listview = (ListView) findViewById(R.id.listviewcomplete);
			
			
			// Pass the results into ListViewAdapter.java
			adapter = new ListViewAdapter(OrderCompleteActivity.this, numberlist);
			...
			listview.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view,
					...
					Intent i = new Intent(OrderCompleteActivity.this,
